...
1. **Explain exactly what will be removed:**
   > "You're about to delete the policy 'Yield Agent — Conservative'
   > (ID: `tb54eps4z44ed0jepousxi4n`).
   > This will remove all spending limits and chain restrictions from
   > wallet `0x...`. This cannot be undone."
...
Effect:  All spending limits and chain restrictions will be removed.
         Any transaction size on any chain will be permitted.
