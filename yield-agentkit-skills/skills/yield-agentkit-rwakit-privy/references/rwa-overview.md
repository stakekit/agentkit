...
`references/yield-output-format.md`. Expand the full country list **live, on request**.
...
| `references/examples.md` | End-to-end gated (Ondo, Superstate) and open-access (Midas) walk-throughs |
