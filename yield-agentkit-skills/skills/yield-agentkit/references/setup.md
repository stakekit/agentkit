...
```bash
claude mcp add yield-agentkit --transport http https://mcp.yield.xyz/mcp --scope project
```
...
Run `claude mcp list` and confirm `yield-agentkit` appears in the output.
