...
| `yield-xyz-agentkit-robinhood` | `/plugin install yield-xyz-agentkit-robinhood@agentkit` | Discover + act on yields on Robinhood Chain (mainnet, chain ID 4663) — chain config + funding across Morpho, Midas, Spark |
