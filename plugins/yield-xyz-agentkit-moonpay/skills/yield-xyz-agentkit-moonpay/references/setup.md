...
Then verify in your agent that `yield-xyz-agentkit` appears in the connected MCP list before continuing.
...
Run `claude mcp list` and confirm both `yield-xyz-agentkit` and `moonpay` appear in the output.
