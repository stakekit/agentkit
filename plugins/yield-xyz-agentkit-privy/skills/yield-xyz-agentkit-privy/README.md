...
```
Set up the yield-xyz-agentkit-privy skill
```
...
Look for `yield-xyz-agentkit-privy` in the skills list. Or ask directly:
...
| Symptom | Fix |
|---|---|
| Skill not triggering | Ask Claude: `Set up the yield-xyz-agentkit-privy skill` |
...
└── references/
    ...
    ├── privy-webhooks.md           # Intent webhook setup
...
- [Privy Recipe](https://docs.privy.io/recipes/yield/yield-xyz-agentkit-guide) - yield-xyz-agentkit-privy skill
